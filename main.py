...
parser.add_argument('-project', type=str, default='DINO instead Conv')
...
# construct the model
ppnet = model.construct_STProtoPNet(pretrained=True, img_size=img_size,
